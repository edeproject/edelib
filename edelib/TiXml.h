 ...
 *
 * All flavors of Visit methods have a default implementation that returns 'true' (continue v
 * isiting). You need to only override methods that are interesting to you. 
 * 
...
public:
	 ...
	 * 
	 * This is a formatted print, and will insert t
	 * abs and newlines. 
	 * 
...
/**
 * \class TiXmlNode
 * \brief Parent class for everything in DOM
 *
...
public:
	...
	/** Non-const form of IterateChildren() */
	...
	/** Non-const version of NextSiblingElement() */
	...
	/** Non-const version of GetDocument() */
...
public:
	...
	size_t Size()									{ return buffer.length(); }
